---
title: "推送打印任务"
path: "004-智慧硬件开发/003-硬件云端接入/004-打印-扫描设备/002-回调通知/001-推送打印任务"
specfusion_id: wecom_15fd99a89688
source_url: "https://developer.work.weixin.qq.com/document/path/96414"
last_updated: "2026-02-12T18:05:45.793Z"
calibrated_from: "SpecFusion"
calibrated_at: "2026-08-11T08:20:52Z"
---
**请求方式：**POST（**HTTPS**）
...
```
{
 ...
 "command":{
 "command_type":"printer_job_submit",
 "open_userid":"xxx",
 "jobid":"JOBID"
 }
}
...
| command | 结构体 | 指令数据 |
| command_type | string |指令类型，打印任务被提交或者设置产生变更，此处固定为printer_job_submit |
| open_userid | string | 发起当前打印任务的用户 |
| jobid | string | 任务id |
