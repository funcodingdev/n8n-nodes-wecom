---
title: "自有模型分析"
path: "002-第三方应用开发/002-服务端API/016-数据与智能专区/013-专区程序调用sdk/016-自有模型分析"
specfusion_id: wecom_3e30aec4bb88
source_url: "https://developer.work.weixin.qq.com/document/path/99835"
last_updated: "2026-07-26T07:00:24.363Z"
calibrated_from: "SpecFusion"
calibrated_at: "2026-08-11T08:42:56Z"
---
应用在专区中的程序可调用本接口传入会话内容，使用自己上传的大语言模型进行会话分析。

**详细说明**
> 该接口仅支持分析**文本、语音、音频存档消息**
> 对于上传的大语言模型，需要在5秒内完成http请求的回包（回包的内容将会被忽略，但仍需要用sdk进行回包构造），之后通过调用[上传异步任务结果](#53367)接口来返回分析的结果。
