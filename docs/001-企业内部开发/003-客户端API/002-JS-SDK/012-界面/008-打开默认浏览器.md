---
title: "打开默认浏览器"
path: "001-企业内部开发/002-服务端API/013-数据与智能专区/008-会话展示组件"
specfusion_id: wecom_629048a2c4e1
source_url: "https://developer.work.weixin.qq.com/document/path/100076"
last_updated: "2026-07-26T05:45:23.931Z"
calibrated_from: "SpecFusion"
calibrated_at: "2026-08-11T08:37:18Z"
---
## 1. 背景介绍
...
#### __error(error: unknown)__

错误回调。

#### __handleModal(event: { modalUrl, modalSize }): boolean | Promise&amp;lt;boolean&amp;gt;__
...
- __modalSize?: { width: number; height: number; }__
...
#### __handleMounted(): void__

视图挂载成功后的回调。

#### __handleUpdated(): void__

视图更新成功后的回调。

### 3.3 组件方法

#### __setData(data: unknown)__
...
| fileName | 文件/文档url | 文件/文档标题。异常情况：<br/>- url错误，展示「链接错误」<br/>- 非本企业的文件/文档，且用户无浏览权限，展示「暂无权限查看该文档/文件」<br/>- 文件url，且应用无“微盘”权限，展示「暂无微盘应用权限」<br/>- 文档url，且应用无“文档”权限，展示「暂无文档应用权限」 |
...
#### __`ww-open-data-export-button`__
...
#### __ScrollViewContext__

增强 scroll-view 实例，可以通过 `ww.createScrollViewContext` 接口获取。

__方法__

__ScrollViewContext.scrollTo(options: { top?: number; left?: number })__
...
__ScrollViewContext.scrollIntoView(selector: string, options?: { block?: string; inline?: string })__
...
1. __会话组件 ww-open-message 渲染视频后，在外部浏览器无法点击预览__
