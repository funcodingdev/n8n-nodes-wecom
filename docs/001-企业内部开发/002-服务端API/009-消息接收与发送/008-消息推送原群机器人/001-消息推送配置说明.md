---
title: "标题一"
path: "001-企业内部开发/002-服务端API/009-消息接收与发送/008-消息推送原群机器人/001-消息推送配置说明"
specfusion_id: wecom_fcebf6951aab
source_url: "https://developer.work.weixin.qq.com/document/path/99110"
last_updated: "2026-02-12T16:35:37.297Z"
calibrated_from: "SpecFusion"
calibrated_at: "2026-08-11T07:31:19Z"
---
##如何使用消息推送
...
>特别特别要注意：一定要<font color="red">**保护好消息推送的webhook地址**</font>，避免泄漏！不要分享到github、博客等可被公开查阅的地方，否则坏人就可以用你的消息推送来发垃圾消息了。
...
| content | 是 | markdown_v2内容，最长不超过4096个字节，必须是utf8编码。</br>特殊的， </br>1. markdown_v2**不支持字体颜色、@群成员**的语法， 具体支持的语法可参考下面说明 </br> 2. 消息内容在**客户端 4.1.36 版本以下(安卓端为4.1.38以下)** 消息表现为**纯文本**，建议使用最新客户端版本体验|
...
```
7. 代码
<pre class="language-javascript"><code class="language-javascript wrap">&#96;这是行内代码&#96;
...
|horizontal_content_list.media_id|String|否|附件的[media_id](#14404/文件上传接口)，horizontal_content_list.type是2时必填|
