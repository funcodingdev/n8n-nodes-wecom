---
title: "编辑文档内容"
path: "001-企业内部开发/002-服务端API/025-文档/003-管理文档内容/001-编辑文档内容"
specfusion_id: wecom_02318842e7d8
source_url: "https://developer.work.weixin.qq.com/document/path/97626"
last_updated: "2026-02-12T16:51:48.571Z"
calibrated_from: "SpecFusion"
calibrated_at: "2026-08-11T07:36:47Z"
---
## 编辑文档内容
...
2. 单次批量更新操作数量 <= 30。
3. 每次更新时，需要先调用[获取文档数据](#44378)接口，以获取最新的文档各个节点的起始位置与结束位置，以便在准确的位置写入新的数据。
