...
import { assignVipAccountsDescription } from './assignVipAccounts';
...
export const wefileDescription: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: '修改文件的安全设置（水印）',
				action: '文件安全设置',
			},
			// 高级功能
			{
				name: '[高级功能] 分配高级功能账号',
				value: 'assignVipAccounts',
				description: '分配应用可见范围内企业成员的高级功能',
				action: '分配高级功能账号',
			},
			{
				name: '[高级功能] 取消高级功能账号',
				value: 'revokeVipAccounts',
				description: '撤销分配应用可见范围企业成员的高级功能',
				action: '取消高级功能账号',
			},
			{
				name: '[高级功能] 获取高级功能账号列表',
				value: 'getVipAccountsList',
