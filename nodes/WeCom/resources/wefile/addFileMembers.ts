...
const showOnly = { resource: ['wefile'], operation: ['addFileMembers'] };
...
export const addFileMembersDescription: INodeProperties[] = [
	{
		...
		default: '',
		description: '文件或文件夹的ID<a href="https://developer.work.weixin.qq.com/document/path/93658" target="_blank">更多信息</a>',
	},
	{
	...
	},
	{
		...
		description: '要添加的成员或部门；可与上方列表合并，合计 1–1000<a href="https://developer.work.weixin.qq.com/document/path/93658" target="_blank">更多信息</a>',
		options: [
			{
				displayName: '成员',
				name: 'members',
