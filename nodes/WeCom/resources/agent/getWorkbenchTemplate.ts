...
export const getWorkbenchTemplateDescription: INodeProperties[] = [
	{
		...
		displayOptions: { show: showOnlyGetWorkbenchTemplate },
		description: '企业应用的唯一标识。<a href="https://developer.work.weixin.qq.com/document/path/92535" target="_blank">官方文档</a>；可与下方选择二选一',
	},
	{
		displayName: '应用(选择)',
