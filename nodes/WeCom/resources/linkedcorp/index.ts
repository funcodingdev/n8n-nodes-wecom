...
export const linkedcorpDescription: INodeProperties[] = [
	{
		...
		options: [
			...
			// 认证与访问
			{ name: '[认证与访问] 获取下级/下游企业的 Access Token', value: 'getLinkedCorpToken', action: '获取下级 / 下游企业的 Access token', description: '获取下级或下游企业的访问令牌' },
			{ name: '[认证与访问] 获取下级/下游企业小程序 Session', value: 'getMiniProgramSession', action: '获取下级 / 下游企业小程序 Session', description: '获取下级或下游企业的小程序会话' },
			{ name: '[认证与访问] 获取应用共享信息', value: 'getAppShareInfo', action: '获取应用共享信息', description: '获取应用在上下游企业间的共享信息' },
			// 客户管理
			{ name: '[客户管理] 已添加客户 ID 转换', value: 'getLinkedCustomer', action: '将 UnionID 转为 External UserID', description: '查询上下游企业已添加客户的 External UserID' },
			...
			// 对接规则管理
			{ name: '[对接规则] 获取对接规则 ID 列表', value: 'getChainRuleList', action: '获取对接规则 ID 列表', description: '获取所有对接规则的 ID 列表' },
			...
			// 其他操作
			{ name: '[其他操作] 查询成员自定义 ID', value: 'getCustomUserId', action: '查询成员自定义 ID', description: '查询成员在上下游企业中的自定义 ID' },
