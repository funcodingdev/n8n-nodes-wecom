...
export const createFormDescription: INodeProperties[] = [
	...
	},
	{
		...
		displayOptions: { show: showOnly },
		default: '',
		description: '父目录fileid, 在根目录时为空间spaceid。父目录ID，可选',
	},
	{
		displayName: '收集表标题',
		name: 'form_title',
	...
	},
	{
		...
		displayOptions: { show: showOnly },
		default: '',
		description: '收集表表头背景图链接。图片URL，可选',
	},
	{
		displayName: '问题列表',
		name: 'questionList',
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						type: 'json',
						default: '{}',
						description: '问题的额外设置(JSON格式)，不同问题类型有相应的设置。详见API文档。高级选项，可选',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'dateTime',
				default: '',
				description: '定时关闭时间。定时重复与定时结束互斥，若都填，优先定时重复。时间不能早于当前时间',
			},
			{
