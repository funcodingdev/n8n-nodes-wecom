...
export const wedocDescription: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: '管理智能表格内容权限开关',
			},
			{
				name: '[权限设置] 查询内容权限规则',
				value: 'getSheetPriv',
				action: '查询内容权限',
				description: '查询智能表格内容权限规则',
			},
			{
				name: '[权限设置] 创建额外权限规则',
			...
			},
			{
				...
				action: '修改规则成员',
				description: '修改权限规则中的成员',
			},
			{
				name: '[权限设置] 删除额外权限规则',
				value: 'deletePrivRule',
				action: '删除权限规则',
				description: '删除智能表格额外权限规则',
			},
			{
				name: '[智能表格] 添加字段编组',
				value: 'addFieldGroup',
				action: '添加编组',
				description: '为智能表格添加字段编组',
			},
			{
				name: '[智能表格] 更新字段编组',
				value: 'updateFieldGroup',
				action: '更新编组',
				description: '更新智能表格字段编组',
			},
			{
				name: '[智能表格] 删除字段编组',
				value: 'deleteFieldGroups',
				action: '删除编组',
				description: '删除智能表格字段编组',
			},
			{
				name: '[智能表格] 查询字段编组',
				value: 'getFieldGroups',
				action: '查询编组',
				description: '查询智能表格字段编组',
			},
			// 管理收集表
			{
				name: '[管理收集表] 创建收集表',
