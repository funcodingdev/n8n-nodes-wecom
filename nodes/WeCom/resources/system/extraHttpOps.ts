...
export const systemExtraHttpOpsDescription: INodeProperties[] = [
	...
	},
	{
		...
		description: '完成二次验证的企业成员 UserID；可与下方选择二选一',
	},
	{
		displayName: '成员(选择)',
		name: 'sys_userid_selected',
		type: 'options',
	...
	},
	{
		...
		description: '当前操作者；必须在应用可见范围内；可与下方选择二选一',
	},
	{
		displayName: '操作者(选择)',
		name: 'launch_operator_userid_selected',
		type: 'options',
		typeOptions: { loadOptionsMethod: 'getAllUsers' },
		default: '',
		displayOptions: {
	...
	},
	{
		...
		description: '需要发起单聊的企业内部成员；必须在应用可见范围内；可与下方选择二选一',
	},
	{
		displayName: '单聊对象(选择)',
		name: 'launch_chat_userid_selected',
		type: 'options',
		typeOptions: { loadOptionsMethod: 'getAllUsers' },
		default: '',
		displayOptions: {
