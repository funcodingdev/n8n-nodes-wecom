...
export const addMomentTaskDescription: INodeProperties[] = [
	...
	{
		displayName: '发表成员UserID列表',
		name: 'sender_user_list',
		type: 'string',
		default: '',
		displayOptions: { show: { ...showOnly, enableVisibleRange: [true] } },
		description: '发表任务执行者 UserID，逗号分隔，最多 10 万；与下方选择合并',
		placeholder: 'zhangshan,lisi',
	},
	{
		displayName: '发表成员(选择)',
		name: 'sender_user_list_selected',
		type: 'multiOptions',
	...
	},
	{
		...
		default: '',
		displayOptions: { show: { ...showOnly, enableVisibleRange: [true] } },
		description: '发表任务执行者部门 ID，逗号分隔；与下方选择合并',
		placeholder: '2,3',
	},
	{
		displayName: '发表部门(选择)',
		name: 'sender_department_list_selected',
		type: 'multiOptions',
