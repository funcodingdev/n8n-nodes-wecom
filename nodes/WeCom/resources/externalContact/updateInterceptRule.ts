...
export const updateInterceptRuleDescription: INodeProperties[] = [
	...
	},
	{
		...
		description: '支持逗号、竖线或换行分隔；成员与部门合计每次最多 1000 个节点，规则成员总数上限为 10000',
	...
	},
	{
		...
		default: '',
		displayOptions: { show: { ...showOnly, enableAddRange: [true] } },
		description: '正整数部门 ID，支持逗号、竖线或换行分隔；成员与部门合计每次最多 1000 个节点',
		placeholder: '1,2,3',
	},
	// 删除适用范围
	{
	...
	},
	{
		...
		description: '支持逗号、竖线或换行分隔；成员与部门合计每次最多 1000 个节点',
		placeholder: 'zhangsan,lisi',
	},
	{
