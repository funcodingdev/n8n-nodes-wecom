...
export const addJoinWayDescription: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		displayOptions: { show: showOnly },
		description: '联系方式的备注信息，用于助记，最多 30 个字符',
	...
	},
	{
		...
		description: '开启后同时发送群名前缀和群起始序号；关闭时由企业微信使用默认命名',
	},
	{
		displayName: '群名前缀',
		name: 'room_base_name',
		...
		displayOptions: { show: { ...showOnly, auto_create_room: [true], customRoomNaming: [true] } },
