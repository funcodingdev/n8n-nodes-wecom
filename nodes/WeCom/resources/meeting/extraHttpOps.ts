...
export const meetingExtraHttpOps: MeetingExtraHttpOp[] = [
	...
	{ id: 'recordDelete', name: '[录制] 删除会议录制', action: '删除会议录制', description: '删除会议录制', path: '/cgi-bin/meeting/record/delete', method: 'POST', needsMeetingId: true },
	{ id: 'recordDeleteFile', name: '[录制] 删除录制文件', action: '删除录制文件', description: '删除录制文件', path: '/cgi-bin/meeting/record/delete_file', method: 'POST', needsMeetingId: true, needsRecordFileId: true },
	{ id: 'recordGetFileList', name: '[录制] 获取录制文件列表', action: '获取录制文件列表', description: '获取录制文件列表', path: '/cgi-bin/meeting/record/get_file_list', method: 'POST', needsMeetingId: true },
	{ id: 'recordGetStatistics', name: '[录制] 获取录制统计', action: '获取录制统计', description: '获取录制统计', path: '/cgi-bin/meeting/record/get_statistics', method: 'POST', needsMeetingId: true },
	{ id: 'recordTranscriptGetDetail', name: '[录制] 获取转写详情', action: '获取录制转写详情', description: '获取录制转写详情', path: '/cgi-bin/meeting/record/transcript/get_detail', method: 'POST', needsMeetingId: true, needsRecordFileId: true },
	{ id: 'recordTranscriptGetParagraphList', name: '[录制] 获取转写段落列表', action: '获取转写段落列表', description: '获取转写段落列表', path: '/cgi-bin/meeting/record/transcript/get_paragraph_list', method: 'POST', needsMeetingId: true, needsRecordFileId: true },
	{ id: 'recordTranscriptSearch', name: '[录制] 搜索转写内容', action: '搜索转写内容', description: '搜索转写内容', path: '/cgi-bin/meeting/record/transcript/search', method: 'POST', needsMeetingId: true, needsRecordFileId: true },
	{ id: 'recordUpdateSharingConfig', name: '[录制] 更新分享设置', action: '更新录制分享设置', description: '更新录制分享设置', path: '/cgi-bin/meeting/record/update_sharing_config', method: 'POST', needsMeetingId: true, needsRecordFileId: true },
	...
	{ id: 'webinarCancel', name: '[网络研讨会] 取消研讨会', action: '取消网络研讨会', description: '取消网络研讨会', path: '/cgi-bin/meeting/webinar/cancel', method: 'POST', needsMeetingId: true },
	{ id: 'webinarCreate', name: '[网络研讨会] 创建研讨会', action: '创建网络研讨会', description: '创建网络研讨会', path: '/cgi-bin/meeting/webinar/create', method: 'POST' },
	{ id: 'webinarEnrollApprove', name: '[网络研讨会] 审批报名', action: '审批研讨会报名', description: '审批研讨会报名', path: '/cgi-bin/meeting/webinar/enroll/approve', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollDelete', name: '[网络研讨会] 删除报名', action: '删除研讨会报名', description: '删除研讨会报名', path: '/cgi-bin/meeting/webinar/enroll/delete', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollGetConfig', name: '[网络研讨会] 获取报名配置', action: '获取研讨会报名配置', description: '获取研讨会报名配置', path: '/cgi-bin/meeting/webinar/enroll/get_config', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollImport', name: '[网络研讨会] 导入报名', action: '导入研讨会报名', description: '导入研讨会报名', path: '/cgi-bin/meeting/webinar/enroll/import', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollList', name: '[网络研讨会] 获取报名列表', action: '获取研讨会报名列表', description: '获取研讨会报名列表', path: '/cgi-bin/meeting/webinar/enroll/list', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollQueryByTmpOpenid', name: '[网络研讨会] 按临时OpenID查询报名', action: '按临时OpenID查询研讨会报名', description: '按临时OpenID查询研讨会报名', path: '/cgi-bin/meeting/webinar/enroll/query_by_tmp_openid', method: 'POST', needsMeetingId: true },
	{ id: 'webinarEnrollSetConfig', name: '[网络研讨会] 设置报名配置', action: '设置研讨会报名配置', description: '设置研讨会报名配置', path: '/cgi-bin/meeting/webinar/enroll/set_config', method: 'POST', needsMeetingId: true },
	{ id: 'webinarGet', name: '[网络研讨会] 获取研讨会详情', action: '获取网络研讨会详情', description: '获取网络研讨会详情', path: '/cgi-bin/meeting/webinar/get', method: 'POST', needsMeetingId: true },
	{ id: 'webinarListGuest', name: '[网络研讨会] 获取嘉宾列表', action: '获取研讨会嘉宾列表', description: '获取研讨会嘉宾列表', path: '/cgi-bin/meeting/webinar/list_guest', method: 'POST', needsMeetingId: true },
	{ id: 'webinarUpdate', name: '[网络研讨会] 更新研讨会', action: '更新网络研讨会', description: '更新网络研讨会', path: '/cgi-bin/meeting/webinar/update', method: 'POST', needsMeetingId: true },
	{ id: 'webinarUpdateGuestList', name: '[网络研讨会] 更新嘉宾列表', action: '更新研讨会嘉宾列表', description: '更新研讨会嘉宾列表', path: '/cgi-bin/meeting/webinar/update_guest_list', method: 'POST', needsMeetingId: true },
	{ id: 'webinarUpdateWarmUp', name: '[网络研讨会] 更新暖场设置', action: '更新研讨会暖场设置', description: '更新研讨会暖场设置', path: '/cgi-bin/meeting/webinar/update_warm_up', method: 'POST', needsMeetingId: true },
];
