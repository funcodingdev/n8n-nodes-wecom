...
export const getResidentEventListDescription: INodeProperties[] = [
	{
		...
		default: 0,
		description:
			'可选。时间戳，筛选 begin_create_time 之后新创建的上报。<a href="https://developer.work.weixin.qq.com/document/path/93518" target="_blank">官方文档</a>',
	},
	{
		displayName: '修改时间起点',
		...
		default: 0,
		description:
			'可选。时间戳，筛选 begin_modify_time 之后新修改的上报。<a href="https://developer.work.weixin.qq.com/document/path/93518" target="_blank">官方文档</a>',
	},
	{
		displayName: '翻页游标',
		name: 'cursor',
