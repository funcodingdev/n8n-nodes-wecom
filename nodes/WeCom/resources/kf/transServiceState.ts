...
export const transServiceStateDescription: INodeProperties[] = [
	{
		...
		name: 'open_kfid',
		type: 'string',
		displayOptions: { show: showOnlyForTransServiceState },
		default: '',
		placeholder: 'wkxxxxxxxxxxxxxxxxxx',
		description: '要变更会话状态的客服账号。<a href="https://developer.work.weixin.qq.com/document/path/94669" target="_blank">官方文档</a>；可与下方选择二选一',
	},
	{
		displayName: '客服账号(选择)',
