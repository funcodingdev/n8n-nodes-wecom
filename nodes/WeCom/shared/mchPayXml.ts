...
/** 完整 URL（字面量便于文档路径覆盖校验） */
export const URL_SEND_REDPACK =
	'https://api.mch.weixin.qq.com/mmpaymkttransfers/sendworkwxredpack';
export const URL_QUERY_REDPACK =
	'https://api.mch.weixin.qq.com/mmpaymkttransfers/queryworkwxredpack';
export const URL_PAY_TO_EMPLOYEE =
